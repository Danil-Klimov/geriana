...
gulp.task('watch', function() {
	...
	gulp.watch(['src/img/*.jpg', 'src/img/*.png', 'src/img/*.svg', 'src/img/*.gif'], gulp.series('images'));
	gulp.watch(['src/*.pug', 'src/pug/*.pug'], gulp.series('pug'));
	gulp.watch(['src/scss/*.scss', 'src/scss/blocks/*.scss', 'src/scss/pages/*.scss'], gulp.series('scss'));
